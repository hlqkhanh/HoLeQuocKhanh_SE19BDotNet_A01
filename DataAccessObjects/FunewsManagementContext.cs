...
public partial class FunewsManagementContext : DbContext
{
    ...
    private string GetConnectionString()
    {
        IConfiguration config = new ConfigurationBuilder()
            ...
            .Build();
        return config["ConnectionStrings:FUNewsManagementDB"] ?? "Server=(localdb)\\MSSQLLocalDB;Database=FUNewsManagement;Trusted_Connection=True;TrustServerCertificate=True;";
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<NewsArticle>(entity =>
        {
            ...
            entity.Property(e => e.NewsImage).HasMaxLength(400).HasColumnName("NewsImage");
